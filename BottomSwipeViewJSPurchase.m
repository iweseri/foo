...
@interface BottomSwipeViewJSPurchase ()
...
{
    return [NSString stringWithFormat:@"%@/api/shop_purchased_list.php?token=%@",APP_API_URL,[[[NSUserDefaults standardUserDefaults] objectForKey:@"tokenString"]mutableCopy]];
}
