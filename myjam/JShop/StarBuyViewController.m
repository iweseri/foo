...
@interface StarBuyViewController ()

@end

@implementation StarBuyViewController
...
{
    return [NSString stringWithFormat:@"%@/api/shop_starbuy_plist_v2.php?token=%@",APP_API_URL,[[[NSUserDefaults standardUserDefaults] objectForKey:@"tokenString"]copy]];
}
